...
public class PurchaseHistoryView implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        List<Reservation> reservations = PurchaseHistory_Controller.getReservations();
        ...
        label_movie_title.setText(reservations.get(0).getMovie_title());
        label_seat.setText(reservations.get(0).getSeat_number());
        label_date.setText(reservations.get(0).getReservation_date());
        label_time.setText(reservations.get(0).getReservation_time());

        PurchaseHistory_Controller.checkPurchaseHistory();
        ...
        button_next_ticket.setOnAction(actionEvent -> {
            ...
            label_movie_title.setText(reservations.get(count.get()).getMovie_title());
            label_seat.setText(reservations.get(count.get()).getSeat_number());
            label_date.setText(reservations.get(count.get()).getReservation_date());
            label_time.setText(reservations.get(count.get()).getReservation_time());
        });
